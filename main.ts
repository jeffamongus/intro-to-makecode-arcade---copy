...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Environment, function (sprite, otherSprite) {
    pause(1000)
    info.changeLifeBy(-1)
})
...
game.onUpdateInterval(5000, function () {
    mySprite3 = sprites.create(img`
        ...
        . . c c c c c c c c c f . . . . 
        `, SpriteKind.Enemy)
    mySprite3.setPosition(randint(40, scene.screenWidth()), randint(40, scene.screenHeight()))
